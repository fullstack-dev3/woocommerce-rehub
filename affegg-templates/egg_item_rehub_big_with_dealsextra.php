    ...
    <div class="product_egg_extra">
        ...
        <div class="product-summary col_item"> 
                        ...
                        <div class="review-text">
                            ...
                            <?php if(!empty($offer_url_first)) : ?> 
                                <div class="priced_block">
                                    <div>
                                        <a class="re_track_btn btn_offer_block" href="<?php echo esc_url($offer_url_first) ?>"<?php echo ''.$items[0]['ga_event'] ?> target="_blank" rel="nofollow sponsored">
            ...
            <?php if (!empty($offer_desc_first)): ?>
                ...
                <p><a class="rehub-main-color read_more_aff" href="<?php echo esc_url($offer_url_first) ?>"<?php echo ''.$items[0]['ga_event'] ?> target="_blank" rel="nofollow sponsored"><?php esc_html_e('Read more on shop website ', 'rehub-theme'); ?>&#8594;</a></p>                  
            <?php endif; ?>             
        </div>           
    </div> 
</div>  
                    ...
                    <div class="rh-flex-center-align rh-flex-justify-center pt15 pb15 mobileblockdisplay">
                        ...
                        <div class="rh_listcolumn rh-flex-grow1 rh_listcolumn_text">
                            <div class="simple_title mb15">
                                <a rel="nofollow sponsored" target="_blank" class="re_track_btn font100 no-color-link blockstyle rehub-main-font lineheight20" href="<?php echo esc_url($afflink) ?>"<?php echo ''.$item['ga_event'] ?>>
