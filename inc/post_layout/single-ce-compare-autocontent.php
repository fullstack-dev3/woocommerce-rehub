                                        ...
                                        <div class="rh_post_layout_rev_price_holder">
                                            ...
                                            <div class="compare-button-holder">
                                                ...
                                                <?php if ($offer_url):?>
                                                    ...
                                                    <a href="<?php echo esc_url($offer_url);?>" class="re_track_btn wpsm-button rehub_main_btn btn_offer_block" target="_blank" rel="nofollow sponsored"><?php echo esc_attr($buy_best_text);?></a>                        
                                                <?php endif;?>                
                                            </div>
